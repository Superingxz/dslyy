...
import com.dsl.network.* // ktlint-disable no-wildcard-imports
    ...
    private fun getRetrofit(): Retrofit {
        return mRetrofit ?: synchronized(this) {
            mRetrofit ?: Retrofit.Builder()
                ...
                .addCallAdapterFactory(com.dsl.base.network.LiveDataCallAdapterFactory())
                .build()
        }
    }
